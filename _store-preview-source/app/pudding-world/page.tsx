...
export default function PuddingWorld({ externalPaused = false }: { externalPaused?: boolean } = {}) {
  ...
  return (
    <Motion.Provider
      value={{ paused: paused || externalPaused, reduced, modal, resume: () => setPaused(false) }}
    >
      <div
        className="patisserie"
        ref={page}
        data-motion={paused || reduced || externalPaused ? 'still' : 'on'}
      >
